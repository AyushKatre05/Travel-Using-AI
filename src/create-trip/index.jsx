...
const CreateTrip = () => {
  ...
  const { saveTripData } = useTripContext();
  ...
  const handleGenerateTrip = async () => {
    ...
    navigate("/create-trip/summary");
  };

  return (
    <div className="px-4 sm:px-10 md:px-32 lg:px-56 xl:px-72 mt-10">
      <h2 className="font-bold text-2xl sm:text-3xl text-center">
        Tell us where you want to plan your trip
      </h2>
      <p className="mt-3 text-gray-500 text-lg sm:text-xl text-center">
      ...
      <div className="mt-10 flex flex-col gap-6 sm:gap-9">
        ...
        <button
          className={`bg-blue-500 text-white py-3 px-6 rounded text-lg mt-6 sm:mt-10 ${
